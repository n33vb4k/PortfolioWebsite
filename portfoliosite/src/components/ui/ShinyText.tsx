...
const ShinyText: React.FC<ShinyTextProps> = ({
  ...
  useAnimationFrame(time => {
    ...
    if (yoyo) {
      ...
      else if (cycleTime < cycleDuration + animationDuration) { const t = cycleTime-cycleDuration; progress.set(directionRef.current===1?100-(t/animationDuration)*100:(t/animationDuration)*100); }
